...
pkgdatadir = $(datadir)/bsp
pkglibdir = $(libdir)/bsp
pkgincludedir = $(includedir)/bsp
top_builddir = .
...
am_bsp_OBJECTS = blockmap.$(OBJEXT) bsp.$(OBJEXT) endian.$(OBJEXT) \
	funcs.$(OBJEXT) level.$(OBJEXT) makenode.$(OBJEXT) \
	picknode.$(OBJEXT)
bsp_OBJECTS = $(am_bsp_OBJECTS)
bsp_LDADD = $(LDADD)
...
ACLOCAL = ${SHELL} /home/ranguli/Projects/bsp/bsp-5.2/missing --run aclocal-1.9
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /home/ranguli/Projects/bsp/bsp-5.2/missing --run tar
AUTOCONF = ${SHELL} /home/ranguli/Projects/bsp/bsp-5.2/missing --run autoconf
AUTOHEADER = ${SHELL} /home/ranguli/Projects/bsp/bsp-5.2/missing --run autoheader
AUTOMAKE = ${SHELL} /home/ranguli/Projects/bsp/bsp-5.2/missing --run automake-1.9
AWK = gawk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -O2 -fomit-frame-pointer -Wall -Wextra -ffast-math -pipe -march=native -Winline -Wwrite-strings -Wundef -Wbad-function-cast -Wcast-align -Wcast-qual -Wdeclaration-after-statement
CPP = gcc -E
CPPFLAGS = 
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
...
MAKEINFO = ${SHELL} /home/ranguli/Projects/bsp/bsp-5.2/missing --run makeinfo
OBJEXT = o
PACKAGE = bsp
PACKAGE_BUGREPORT = 
PACKAGE_NAME = bsp
PACKAGE_STRING = bsp 5.2
PACKAGE_TARNAME = bsp
PACKAGE_VERSION = 5.2
PATH_SEPARATOR = :
SET_MAKE = 
...
infodir = ${prefix}/info
install_sh = /home/ranguli/Projects/bsp/bsp-5.2/install-sh
...
bsp$(EXEEXT): $(bsp_OBJECTS) $(bsp_DEPENDENCIES) 
	@rm -f bsp$(EXEEXT)
	$(LINK) $(bsp_LDFLAGS) $(bsp_OBJECTS) $(bsp_LDADD) $(LIBS)
